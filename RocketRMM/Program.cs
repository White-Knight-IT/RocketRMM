...
CoreEnvironment.CacheDir = CoreEnvironment.TryGetSetting(builder, "ApiSettings:CachePath", $"{CoreEnvironment.PersistentDir}{Path.DirectorySeparatorChar}cache").Trim();
